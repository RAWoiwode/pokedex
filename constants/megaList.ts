const MEGA_POKEMON = new Map([
  ...
  ["latias", 1],
  ["latios", 1],
  ["garchomp", 2], // 'mega' & 'mega-z'
  ["lucario", 2], // 'mega' & 'mega-z'
  ["abomasnow", 1],
  ...
  ["greninja", 1],
  ["pyroar", 1],
  ["floette-eternal", 1], // 'floette-mega'
  ["malamar", 1],
  ["barbaracle", 1],
  ["dragalge", 1],
  ["hawlucha", 1],
  ["zygarde-complete", 1], // 'zygarde-mega'
  ["drampa", 1],
  ["falinks", 1],

  // Pokemon Legends Z-A: Mega Dimension (DLC)
  ["raichu", 2], // 'mega-x' & 'mega-y'
  ["chimecho", 1],
  ["staraptor", 1],
  ["heatran", 1],
  ["darkrai", 1],
